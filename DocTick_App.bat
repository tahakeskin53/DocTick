...
chcp 65001 >nul
cd /d "%~dp0"
echo DocTick App (kurulabilir PWA) hazirlaniyor...
echo.
...
if errorlevel 1 (
  ...
  echo        NOT: Yeni derlemeyi gormek icin "DocTick App (5080)" penceresini kapatip bu BAT'i yeniden calistirin.
)
...
echo.
echo Durdurmak icin "DocTick App (5080)" penceresini kapatin (Ctrl+C).

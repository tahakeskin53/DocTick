...
public record DoctorDto(int Id, string Name, int DepartmentId, string DepartmentName, bool IsActive, string PhotoUrl, string Bio, string Education, string Interests, bool IsChief);

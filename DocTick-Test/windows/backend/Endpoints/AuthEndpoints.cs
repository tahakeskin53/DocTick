...
public static class AuthEndpoints
{
    public static IEndpointRouteBuilder MapAuthEndpoints(this IEndpointRouteBuilder app, IConfiguration cfg)
    {
        ...
        grp.MapPost("/google", async (GoogleLoginRequest req, AppDb db, HttpContext ctx) =>
        {
            ...
            // Test sürümü: Auth:AutoApprove=true ise herkes doğrudan Active (onay beklemez).
            var autoApprove = bool.TryParse(cfg["Auth:AutoApprove"], out var b) && b;
            ...
            if (user is null)
            {
                ...
                user = new User
                {
                    ...
                    Status = (autoApprove || isAdmin || isPreApproved) ? UserStatus.Active : UserStatus.Pending,
